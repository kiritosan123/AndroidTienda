...
public class MainActivity extends AppCompatActivity {
        ...
        btn_register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(edt_birthdate.getText().toString())){
                    Toast.makeText(MainActivity.this, "Por favor ingresa tu cumple", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                waitingDialog.show();
                waitingDialog.setMessage("Por favor espere Haber...!");
    ...
    private void printKeyHash() {
        try {
            PackageInfo info = getPackageManager().getPackageInfo("com.example.kirito.androidtienda", PackageManager.GET_SIGNATURES);
